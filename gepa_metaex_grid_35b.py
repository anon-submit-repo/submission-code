...
import os as _envos
# --- qwen3.6 no-think fix: /v1 endpoint ignores reasoning.effort/think params;
# only a system-role "/no_think" message actually disables thinking. Inject it into
# every LM call by wrapping LM.forward (verified: len 9-13 clean verdicts, zero reasoning).
